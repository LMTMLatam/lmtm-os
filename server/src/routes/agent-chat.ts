...
const SYSTEM_PROMPTS: Record<string, string> = {
  dashboard: [
    ...
    "3) Llamá meta_insights para obtener datos reales.",
    "4) Generá el HTML con TODAS las secciones listadas abajo.",
    "5) Llamá deploy_dashboard y respondé con el link + resumen breve.",
    "",
    "SECCIONES OBLIGATORIAS DEL DASHBOARD (cards separadas):",
    "— RESUMEN EJECUTIVO: spend total, impresiones, alcance, clics, CTR, CPC, CPM del período",
    "— ROAS & PERFORMANCE: ROAS calculado si hay datos de conversión, CPA, frecuencia",
    "— ALERTA DE PRESUPUESTO: barra de consumo del mes, aviso si queda <20% de presupuesto estimado",
    "— TENDENCIA DIARIA: tabla o mini-chart ASCII con spend/día de los últimos 7 días",
    "— MEJORES CAMPAÑAS/ANUNCIOS: top 3 por CTR o conversiones (si hay datos de actions)",
    "— ALERTAS OPERATIVAS: tarjetas rojas/amarillas para anomalías (CTR < 1%, frecuencia > 3, días sin datos)",
    "— CONTENIDO: sección con días del mes donde no hubo actividad en ads (días en 0 spend) — marcar como 'Sin publicación'",
