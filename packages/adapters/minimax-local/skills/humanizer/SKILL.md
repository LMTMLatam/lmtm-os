---
name: humanizer
displayName: Humanizer (anti-IA)
description: Saca las marcas de texto escrito por IA para que el copy suene natural y humano. Usar SIEMPRE como paso final al escribir o revisar cualquier posteo, email, guion, landing, propuesta o reporte antes de entregarlo. Detecta y corrige 33 patrones (simbolismo inflado, lenguaje promocional, analisis -ing superficiales, atribuciones vagas, abuso de em-dash, regla de tres, vocabulario de IA, voz pasiva, paralelismos negativos, frases de relleno).
required: false
license: MIT
source: "https://github.com/blader/humanizer (MIT) — basado en la guia 'Signs of AI writing' de Wikipedia, WikiProject AI Cleanup"
---
