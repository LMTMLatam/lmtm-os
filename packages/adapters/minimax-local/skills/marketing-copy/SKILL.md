...
description: Frameworks y proceso para escribir copy persuasivo (landings, ads, emails, redes): estructura, ángulos, CTAs y ejemplos. Usala al redactar o mejorar cualquier copy.
required: false
---
