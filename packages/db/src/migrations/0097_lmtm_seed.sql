...
VALUES (
  '00000000-0000-0000-0000-00000000lmtm',
  'LMTM',
...
VALUES
  ...
  ('11111111-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000lmtm', 'Luna (CMO)', 'cmo', 'Chief Marketing Officer', 'compass', 'idle', 'minimax_cloud',
  ...
  ('11111111-0000-0000-0000-000000000002', '00000000-0000-0000-0000-00000000lmtm', 'Milo (Paid Media)', 'pm', 'Paid Media Manager', 'megaphone', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- Content Strategist
  ('11111111-0000-0000-0000-000000000003', '00000000-0000-0000-0000-00000000lmtm', 'Camila (Content)', 'pm', 'Content Strategist', 'pen-line', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- SEO Specialist
  ('11111111-0000-0000-0000-000000000004', '00000000-0000-0000-0000-00000000lmtm', 'Sergio (SEO)', 'engineer', 'SEO Specialist', 'search', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
   '{"heartbeat": {"enabled": true, "intervalSec": 86400, "wakeOnDemand": true, "maxConcurrentRuns": 1}}'::jsonb,
   30000, '{"lmtm_role": "seo"}'::jsonb, now(), now()),

  -- Data Analyst
  ('11111111-0000-0000-0000-000000000005', '00000000-0000-0000-0000-00000000lmtm', 'Delfina (Data)', 'researcher', 'Data Analyst', 'line-chart', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- Dashboard Builder
  ('11111111-0000-0000-0000-000000000006', '00000000-0000-0000-0000-00000000lmtm', 'Dario (Dashboards)', 'engineer', 'Dashboard Builder', 'layout-dashboard', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- n8n Orchestrator
  ('11111111-0000-0000-0000-000000000007', '00000000-0000-0000-0000-00000000lmtm', 'Nicolas (n8n)', 'engineer', 'n8n Orchestrator', 'workflow', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- CRM Analyst
  ('11111111-0000-0000-0000-000000000008', '00000000-0000-0000-0000-00000000lmtm', 'Ana (CRM Analyst)', 'researcher', 'CRM Analyst', 'database', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- CRM Engineer
  ('11111111-0000-0000-0000-000000000009', '00000000-0000-0000-0000-00000000lmtm', 'Esteban (CRM Engineer)', 'engineer', 'CRM Engineer', 'wrench', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
   '{"heartbeat": {"enabled": false, "intervalSec": 0, "wakeOnDemand": true, "maxConcurrentRuns": 1}}'::jsonb,
   20000, '{"lmtm_role": "crm_engineer"}'::jsonb, now(), now()),

  -- Conversion Specialist
  ('11111111-0000-0000-0000-00000000000a', '00000000-0000-0000-0000-00000000lmtm', 'Carla (Conversion)', 'pm', 'Conversion Specialist', 'target', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- Brand Guardian
  ('11111111-0000-0000-0000-00000000000b', '00000000-0000-0000-0000-00000000lmtm', 'Bianca (Brand)', 'designer', 'Brand Guardian', 'shield', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
   '{"heartbeat": {"enabled": false, "intervalSec": 0, "wakeOnDemand": true, "maxConcurrentRuns": 1}}'::jsonb,
   15000, '{"lmtm_role": "brand_guardian"}'::jsonb, now(), now()),

  -- Competitor Intel
  ('11111111-0000-0000-0000-00000000000c', '00000000-0000-0000-0000-00000000lmtm', 'Carlos (Competitor)', 'researcher', 'Competitor Intel', 'binoculars', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
  ...
  -- Reporting
  ('11111111-0000-0000-0000-00000000000d', '00000000-0000-0000-0000-00000000lmtm', 'Roxana (Reports)', 'pm', 'Reporting', 'file-text', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
   '{"heartbeat": {"enabled": true, "intervalSec": 86400, "wakeOnDemand": true, "maxConcurrentRuns": 1}}'::jsonb,
   15000, '{"lmtm_role": "reporting", "cron": "0 11 * * * America/Argentina/Buenos_Aires"}'::jsonb, now(), now()),

  -- PM/Coordinator
  ('11111111-0000-0000-0000-00000000000e', '00000000-0000-0000-0000-00000000lmtm', 'Pablo (PM)', 'pm', 'PM/Coordinator', 'gantt-chart', 'idle', 'minimax_cloud',
   '{"model": "MiniMax-M3"}'::jsonb,
...
VALUES
  ('22222222-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000lmtm',
  ...
  ('22222222-0000-0000-0000-000000000002', '00000000-0000-0000-0000-00000000lmtm',
  ...
  ('22222222-0000-0000-0000-000000000003', '00000000-0000-0000-0000-00000000lmtm',
  ...
  ('22222222-0000-0000-0000-000000000004', '00000000-0000-0000-0000-00000000lmtm',
